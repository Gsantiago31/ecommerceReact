    ...
    <DashboardLayout>
        ...
        <Grid container className="animate__animated animate__fadeIn animate__slow" sx={{backgroundColor: 'dashboard.background', width: '100vw', height: '100vh', p: '20px'}}>
            ...
            <Grid item xs={12} sx={{display: 'flex', flexDirection: 'row', justifyContent: 'space-around'}}>
                ...
                <CardProfile name={'Valentina'} rol={'Fundadora'} url={'https://firebasestorage.googleapis.com/v0/b/viv-twins.appspot.com/o/vale.JPG?alt=media&token=945d1180-cfed-4a8b-828a-c27e45eb6789'}/>
            </Grid> 
        </Grid>
